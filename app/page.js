              ...
              <div className="grid-style1 clearfix">
                <div className="item col-md-4">
                  <div className="image">
                    ...
                    <Image src="http://placehold.it/760x670" alt="" />
                  </div>
                  <div className="price">
                    <span>$950</span>
                    <p>per night</p>
              ...
              <div className="row">
                <div className="col-sm-12">
                  ...
                  <div id="regions">
                    <div className="item">
                      <Link href="#">
                        <Image src="http://placehold.it/194x194" alt="" />
                        <h3>Rhovanion</h3>
                      </Link>
                    </div>
                    <div className="item">
              ...
              <div className="grid-style1">
                <div className="item col-md-4">
                  <div className="image">
                    ...
                    <Image src="http://placehold.it/766x515" alt="" />
                  </div>
                  <div className="tag">
                ...
                <ul className="latest-news">
                  <li className="col-md-12">
                    <div className="image">
                      ...
                      <Image alt="" src="http://placehold.it/100x100" />
                    </div>
              ...
              <div className="col-sm-12">
                ...
                <ul className="activity">
                  <li className="col-lg-12">
                    <Link href="#">
                      <Image src="http://placehold.it/70x70" alt="" />
                    </Link>
                    <div className="info">
                      <h5>
                        Sam Minnée reviewed
